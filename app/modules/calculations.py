...
CALCULATIONS_CONFIG = {
    ...
    'DEFAULT_UN_TON': 50.0,    # Varsayılan üretim tonajı
    'DEFAULT_BUGDAY_HIZ': 5300.0, # Kg/Saat
...
def show_enzim_dozajlama():
    ...
    # ==========================================================================
    # SEKME 2: REÇETE GEÇMİŞİ VE ARŞİV
    # ==========================================================================
    with tab_gecmis:
        ...
        if df_arsiv.empty:
            ...
            st.dataframe(
                ...
                column_config={"Tarih": st.column_config.DatetimeColumn("Tarih", format="DD.MM.YYYY HH:mm")}
            )
